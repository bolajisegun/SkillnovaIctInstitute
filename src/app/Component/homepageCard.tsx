...
const HomepageCard = () => {
  return (
    <div>
      <div className="courseImg w-[350px] bg-white rounded-md shadow-md p-4 flex flex-col items-center">
        <Image src={CourseImage} alt="Course Image" />
        <div className="courseInfo">
          <h5 className="courseSubtitle text-[#4A90E2] my-4 text-[12px] font-semibold">
            Programming
          </h5>
          <h3 className="courseTitle font-bold mb-1 text-[15px]">
            React & Next.js Full Course
          </h3>
          <p className="courseDescription text-[13px]">
          ...
          <div className="courseActions flex items-center justify-between mt-4 w-full">
            <div className="rating flex items-center gap-1 text-md text-yellow-500">
              <CiStar />
              <CiStar />
              <CiStar />
              <CiStar />
            ...
            <div className="price font-semibold text-[#4A90E2]">
              <h5>#1,500</h5>
            </div>
          </div>
          <Link
